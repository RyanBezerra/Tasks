document.addEventListener('DOMContentLoaded', function() {
      ...
      <div class="col-12 col-md-6 col-lg-4">
        <div class="client-card">
          ...
          <div class="client-content">
            <div class="client-name text-black">Cliente ${number}</div>
            <div class="client-info">
              <div class="client-detail">
                ...
                <span class="text-black">(83) 9${Math.floor(Math.random() * 9000) + 1000}-${Math.floor(Math.random() * 9000) + 1000}</span>
              </div>
              <div class="client-detail">
  ...
  // Add input and button to control card quantity
